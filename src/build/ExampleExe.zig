//! A struct that creates and configures an exe used to run a zig-objective-c-runtime example.

const std = @import("std");
const BuildConfig = @import("BuildConfig.zig");
const ZigObjectiveCRuntimeModule = @import("ZigObjectiveCRuntimeModule.zig");
...
/// Initializes a new ExampleExe struct with the provided name, BuildConfig, and
/// ZigObjectiveCRuntimeModule.
///
/// ## Remarks
/// This also adds the provided ZigObjectiveCRuntimeModule as an import with the alias
/// "objective_c_runtime" to the newly
/// initialized exe.
pub fn init(b: *std.Build, build_config: *const BuildConfig, module: *const ZigObjectiveCRuntimeModule, name: []const u8) ExampleExe {
    ...
    examples_exe.root_module.addImport("objective_c_runtime", module.module);
